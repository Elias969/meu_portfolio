  ...
  return (
    <section className="flex flex-col items-center text-center py-20">
      ...
      <div className="flex gap-4">
        ...
        <a href="/curriculo_elias_ramos_da_rocha.pdf" download className="border border-green-400 px-6 py-2 rounded-lg hover:bg-green-400 hover:text-black transition">Download CV</a>
      </div>
    </section>
  );
}
